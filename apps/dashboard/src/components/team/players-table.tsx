...
export default function PlayersTable() {
  ...
  return (
    <div className="overflow-x-auto">
      <Table>
        <TableCaption className="space-y-4 px-4">
              ...
              <TableRow key={player?.id}>
                <TableCell className="font-medium">
                  <div className="flex items-center">
                    <div className="relative me-3 inline-block shrink-0 rounded-2xl">
                      <Image
                        width={42}
                        height={42}
                ...
                <TableCell>
                  <span className="bg-success-light mr-auto inline-flex items-center rounded-lg px-2 py-1 text-center align-baseline text-base/none font-semibold">
