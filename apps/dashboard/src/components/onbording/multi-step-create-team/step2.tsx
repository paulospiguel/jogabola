...
export const Step2 = React.forwardRef<HTMLDivElement>((props, ref) => {
	...
	return (
		<div ref={ref}>
			<Image src={gameDay} className="mx-auto" alt="sentado no sofa na torcida" width={280} height={280} />
			<div className="mx-auto max-w-md space-y-6 py-12">
				<div className="space-y-2 text-center">
					<h2 className="text-2xl font-bold">Aceite os Termos de Uso</h2>
					<p className="text-slate-100">Antes de prosseguir, você precisa aceitar nossos Termos de Uso.</p>
				</div>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
											<FormControl>
												<Checkbox className="border-gray-50" checked={field.value} onCheckedChange={field.onChange} />
											</FormControl>
