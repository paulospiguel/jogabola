import { pgTable, foreignKey, text, timestamp, unique, serial, jsonb, boolean, doublePrecision, integer, primaryKey, varchar } from "drizzle-orm/pg-core"
...
export const timer = pgTable("timer", {
	...
	primaryKey({ columns: [table.userId, table.key], name: "timer_user_id_key_pk"}),
]);
