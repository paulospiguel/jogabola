      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-white/50 max-w-xl">
            Gere as informações administrativas básicas, detalhes de contacto e configurações críticas do teu clube desportivo.
          </p>
        </div>
      </div>
        ...
        {activeTab === "general" && (
          <motion.div key="general" {...fadeUp} transition={{ duration: 0.3 }}>
            <div className="rounded-3xl border border-white/8 bg-white/3 p-6 md:p-8 backdrop-blur shadow-[0_35px_80px_-45px_rgba(111,255,233,0.1)]">
              <h3 className="text-base font-bold text-white mb-6">Informações Gerais</h3>
              <GeneralSettingsForm />
            </div>
          </motion.div>
        )}
