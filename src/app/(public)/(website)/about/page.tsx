...
export default function SobrePage() {
  ...
  // Business values with translations
  const values = [
    {
      title: businessT("values.passion.title"),
      description: businessT("values.passion.description"),
      icon: infoBusiness.values[0].icon,
    },
    {
      title: businessT("values.accessibility.title"),
      description: businessT("values.accessibility.description"),
      icon: infoBusiness.values[1].icon,
    },
    {
      title: businessT("values.community.title"),
      description: businessT("values.community.description"),
      icon: infoBusiness.values[2].icon,
    },
    {
      title: businessT("values.innovation.title"),
      description: businessT("values.innovation.description"),
      icon: infoBusiness.values[3].icon,
    },
  ];

  // Business benefits with translations
  const benefits = [
    {
      title: businessT("benefits.findNearby.title"),
      description: businessT("benefits.findNearby.description"),
      icon: infoBusiness.benefits[0].icon,
    },
    {
      title: businessT("benefits.reserveFields.title"),
      description: businessT("benefits.reserveFields.description"),
      icon: infoBusiness.benefits[1].icon,
    },
    {
      title: businessT("benefits.joinTournaments.title"),
      description: businessT("benefits.joinTournaments.description"),
      icon: infoBusiness.benefits[2].icon,
    },
    {
      title: businessT("benefits.connectPlayers.title"),
      description: businessT("benefits.connectPlayers.description"),
      icon: infoBusiness.benefits[3].icon,
    },
  ];
  ...
  const team = [
    {
      name: businessT("team.paulo.name"),
      role: businessT("team.paulo.role"),
      bio: businessT("team.paulo.bio"),
      image: infoBusiness.team[0].image,
    },
  ];
    ...
    <div className="container mx-auto px-4 py-12">
        ...
        <h2 className="relative z-10 text-center font-sans text-2xl font-bold tracking-tight text-black md:text-4xl lg:text-7xl dark:text-white">
          ...
          <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
            <div className="relative bg-gradient-to-r from-purple-500 via-teal-500 to-pink-500 bg-clip-text bg-no-repeat py-4 text-transparent">
              <span className="text-4xl">{businessT("slogan")}</span>
            </div>
          </div>
        </h2>
      ...
      <section className="mt-8 mb-16">
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <Text variant="lead">{businessT("mission")}</Text>
          </motion.div>
          ...
          >
            ...
            <Text variant="lead">{businessT("vision")}</Text>
          </motion.div>
        </div>
      ...
      <section className="mb-8 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          {/* <motion.a
            href={infoBusiness.socialMedia.twitter}
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.2, rotate: 5 }}
            whileTap={{ scale: 0.9 }}
          ...
          {/* <motion.a
            href={infoBusiness.socialMedia.facebook}
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.2, rotate: 5 }}
            whileTap={{ scale: 0.9 }}
