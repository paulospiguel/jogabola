...
import { Calendar, MapPin, Trophy, Users } 
import {
  Card,
  CardContent,
  CardDescription,
...
export const TabsTeam = ({ team }: { team: Team }) => {
  ...
  return (
    <Tabs defaultValue="overview" className="w-full">
        ...
        <div className="mt-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              ...
              <Progress
                value={(teamData.won / teamData.played) * 100}
                className="flex-1"
              />
            ...
            <div className="flex items-center">
              ...
              <Progress
                color="warning"
                value={(teamData.drawn / teamData.played) * 100}
                className="flex-1"
              />
            ...
            <div className="flex items-center">
              ...
              <Progress
                color="error"
                value={(teamData.lost / teamData.played) * 100}
                className="flex-1"
              />
      ...
      <TabsContent value="players" className="space-y-4 px-4">
        <HeaderTitle
          title="Players"
          description="Here contens your players that have into you team"
        />
        <PlayersList />
      </TabsContent>
