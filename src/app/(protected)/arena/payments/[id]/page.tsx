      ...
      <div className="jb-page-inner">
        <header className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              className="border-arena-danger/20 text-arena-danger hover:bg-arena-danger/10"
            >
              ...
              <div className="grid gap-8 p-6 md:grid-cols-2">
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b border-arena-border/50 pb-2">
                    ...
                    <span className="text-2xl font-black text-arena-primary">
                      {payment.amount}
                    </span>
                  </div>
                  <div className="flex items-center justify-between border-b border-arena-border/50 pb-2">
              ...
              <div className="p-6">
                {payment.proofUrl ? (
                  ...
                  <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-arena-border py-12 text-arena-text-muted">
                    ...
                    <Button
                      variant="outline"
                      className="mt-6 border-arena-primary/30 text-arena-primary hover:bg-arena-primary/10"
                    >
                      {t("detail.verify")}
                    </Button>
                  </div>
            ...
            <section className="jb-card p-6">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-1 text-sm text-arena-text-muted">
                  {t("detail.memberSince", { year: 2023 })}
                </p>

                <div className="mt-8 grid w-full gap-2">
                  <Link href={`/arena/squads/${payment.player.id}`}>
                    <Button
                      variant="outline"
                      className="w-full border-arena-border hover:bg-arena-primary/10 hover:text-arena-primary"
                    >
                  ...
                  <Button
                    variant="ghost"
                    className="w-full text-arena-text-muted hover:text-arena-text"
                  >
                ...
                {(
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      "border-arena-primary bg-arena-primary/10 shadow-[0_0_15px_rgba(59,130,246,0.1)]",
                    )}
                  >
