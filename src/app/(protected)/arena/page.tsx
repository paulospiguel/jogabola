...
const quickActions = [
  { label: "Add Player", icon: Users, href: null, action: "addPlayer" },
  { label: "Fees Status", icon: Wallet, href: "/arena/finances", action: null },
  { label: "Assign Kit", icon: Shield, href: "/arena/kits", action: null },
  { label: "Announce", icon: Volume2, href: "/arena/announcements", action: null },
] as const;
...
function StatusBadge({ status }: { status: TeamStatus }) {
  const map: Record<TeamStatus, { label: string; color: string; bg: string }> = {
    TRAINING: { label: "Training", color: "#6fffe9", bg: "rgba(111,255,233,0.12)" },
...
export default function ArenaPage() {
  ...
  const liveStatCards = statCards.map(c =>
    c.title === "Active Players" ? { ...c, value: String(playerCount) } : c,
  );
  ...
  return (
    ...
    <div className="min-h-screen px-6 py-8 text-white">
      ...
      >
        <div>
          <p className="mb-1 text-xs font-bold uppercase tracking-[0.3em] text-[#6fffe9]">
            Arena · Club Manager
          </p>
          <h1 className="font-heading text-4xl font-black italic tracking-wide text-white">
            CLUB OVERVIEW
          </h1>
          ...
          return (
            ...
            >
              <div className="mb-3 flex items-center justify-between">
                ...
                <Icon
                  className="h-4 w-4"
                  style={{ color: card.highlight ? "#6fffe9" : "rgba(255,255,255,0.3)" }}
                />
              </div>
              ...
              <p
                ...
                style={{ color: card.highlight ? "#6fffe9" : "rgba(255,255,255,0.4)" }}
              >
                {card.sub}
              </p>
              {card.highlight && (
      ...
      <div className="grid gap-6 lg:grid-cols-3">
                  ...
                  <div key={item.month} className="group flex flex-1 flex-col items-center gap-2">
                    <div className="relative flex w-full flex-1 items-end">
                      <div
                        ...
                        style={{
                          height: `${heightPct}%`,
                          backgroundColor: isHighest ? "#24ffe6" : "rgba(111,255,233,0.25)",
                          boxShadow: isHighest ? "0 0 24px rgba(36,255,230,0.5)" : undefined,
                        }}
                      />
                    </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <h2 className="mb-5 text-base font-bold text-white">Management</h2>
