...
export function DangerZone({ pendingTransfer: initialPending }: DangerZoneProps) {
  ...
  const profileDangerZoneLabel = (sentence: string) => {
    return t(`profileDangerZone.${sentence}`);
  };

  const commonLabel = (sentence: string) => {
    return t(`common.${sentence}`);
  };
    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-4">
        ...
        <div className="relative">
          <div className="absolute opacity-75 inset-0 z-10 flex items-center justify-center bg-arena-surface text-lg font-bold text-arena-text">
            {t("common.comingSoon")}
          </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                <h3 className="font-bold text-arena-text">
                  {profileDangerZoneLabel("transfer.title")}
                </h3>
                <p className="text-sm text-arena-text-sec">
                  {profileDangerZoneLabel("transfer.description")}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-4">
              {pending ? (
                ...
                <div className="space-y-2">
                  ...
                  >
                    {profileDangerZoneLabel("transfer.label")}
                  </Label>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        ...
                        >
                          ...
                          {profileDangerZoneLabel("transfer.button")}
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent className="border-arena-border bg-arena-surface shadow-2xl">
                        ...
                        <AlertDialogFooter>
                          ...
                          >
                            {profileDangerZoneLabel("transfer.confirm.action")}
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
                    </AlertDialog>
              ...
              {error && (
                <p className="text-xs font-medium text-red-400">
                  {error === "EMAIL_ALREADY_IN_USE"
                    ? commonLabel("error.emailInUse")
                    : commonLabel("error.generic")}
                </p>
              )}
            </div>
          </div>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                ...
                >
                  ...
                  {profileDangerZoneLabel("delete.button")}
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="border-red-500/30 bg-arena-surface shadow-2xl">
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-arena-text">
                    {profileDangerZoneLabel("delete.confirm.title")}
                  </AlertDialogTitle>
                  <AlertDialogDescription className="text-arena-text-sec">
                    {profileDangerZoneLabel("delete.confirm.description")}
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel className="border-arena-border bg-transparent text-arena-text hover:bg-arena-surface-el">
                  ...
                  >
                    {profileDangerZoneLabel("delete.confirm.action")}
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
