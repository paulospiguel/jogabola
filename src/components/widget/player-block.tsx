import { Dribbble, Facebook, Linkedin, X }from "@/components/icons";
...
const PlayerBlock: React.FC<PlayerBlockProps> = ({
  ...
  return (
    <div className="group flex h-52 w-52 flex-col items-center justify-center rounded-3xl bg-cyan-200 p-4 shadow-sm transition-all duration-300 hover:shadow-black/25 dark:bg-zinc-800">
      ...
      <div className="bg-background/70 dark:bg-background/25 mt-2 flex w-full flex-row justify-evenly rounded-3xl p-2 text-foreground">
        <a
