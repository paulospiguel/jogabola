...
export default function ScheduleEventWidget({
  ...
  return (
    <div
      className={cn(
        "group relative flex size-full flex-col overflow-hidden rounded-3xl border-2 bg-white p-4",
      )}
    >
