  ...
  const sidebarContent = (
    <div className="flex h-full flex-col text-slate-800 transition-colors dark:text-white">
      ...
      <div className="flex items-center justify-between border-b border-emerald-100/60 bg-white/80 p-4 md:hidden dark:border-white/10 dark:bg-white/5">
        <h2 className="bg-linear-to-r from-emerald-500 to-sky-500 bg-clip-text text-lg font-bold text-transparent dark:from-neon-secondary dark:to-accent-blue">
          ⚽ Menu
        </h2>
        <Button
          variant="ghost"
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "scale-105 border border-emerald-300 bg-emerald-100/70 text-emerald-700 shadow-[0_20px_50px_-30px_rgba(16,185,129,0.45)] dark:border-neon-secondary/40 dark:bg-white/10 dark:text-white dark:shadow-[0_25px_60px_-35px_rgba(36,255,230,0.8)]"
              ...
              >
                <Icon
                  className={cn(
                    ...
                    isActive
                      ? "text-emerald-600 dark:text-neon-secondary"
      ...
      <div className="border-t border-emerald-100/60 p-4 dark:border-white/10">
        <div className="relative overflow-hidden rounded-2xl border border-emerald-100/70 bg-emerald-50/90 p-5 shadow-[0_20px_50px_-35px_rgba(16,185,129,0.35)] backdrop-blur dark:border-white/10 dark:bg-white/5 dark:shadow-[0_20px_50px_-35px_rgba(36,255,230,0.6)]">
          <div className="absolute -top-6 -right-4 h-24 w-24 rounded-full border border-emerald-300/30 dark:border-neon-secondary/20" />
          <div className="absolute -bottom-4 -left-2 h-20 w-20 rounded-full border border-sky-300/30 dark:border-accent-blue/20" />

          <div className="relative">
            <h3 className="mb-2 flex items-center gap-2 text-base font-bold text-emerald-700 dark:text-white">
              <Trophy className="h-5 w-5 text-emerald-500 dark:text-neon-secondary" />
              Seja Pro! 🚀
            </h3>
            ...
            <Button
              size="sm"
              className="group w-full bg-emerald-500 font-semibold text-white shadow-[0_16px_45px_-20px_rgba(16,185,129,0.6)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-emerald-600 dark:bg-neon-secondary dark:text-slate-900 dark:shadow-[0_16px_45px_-20px_rgba(36,255,230,0.9)] dark:hover:bg-neon-secondary/90"
            >
              Fazer Upgrade
            </Button>
          </div>
