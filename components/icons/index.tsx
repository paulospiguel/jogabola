...
export function FieldSoccer(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 512 512" {...props}>
			<title>FieldSoccer</title>
			<path
				d="M32 96h448v320H32z"
				style={{
					fill: "#6ebf5d",
				}}
			/>
			<path
				d="M496 448H16c-8.836 0-16-7.164-16-16V80c0-8.836 7.164-16 16-16h480c8.836 0 16 7.164 16 16v352c0 8.836-7.164 16-16 16zM32 416h448V96H32v320z"
				style={{
					fill: "#003b54",
				}}
			/>
			<path
				d="M336 256.016c.016-38.703-27.492-70.985-64-78.406V96h-32v81.61c-36.515 7.422-64.015 39.703-64 78.406-.007 38.703 27.477 70.969 64 78.382V416h32v-81.602c36.508-7.413 64.016-39.679 64-78.382zm-127.992 0c.008-20.89 13.367-38.61 31.992-45.203v90.406c-18.625-6.593-31.984-24.313-31.992-45.203zM272 301.211v-90.406c18.633 6.586 32 24.321 32 45.195-.007 20.875-13.367 38.61-32 45.211zM480.016 320h-32.032c-8.797 0-16-7.202-16-16v-96c0-8.797 7.203-16 16-16h32.024l.008-32h-32.032C421.586 160 400 181.61 400 208v96c0 26.406 21.586 48 47.984 48h32.024l.008-32zM31.984 192h32.032c8.797 0 16 7.203 16 16v96c0 8.798-7.203 16-16 16H31.984v32H64.016C90.414 352 112 330.406 112 304v-96c0-26.39-21.586-48-47.984-48H31.984v32z"
				style={{
					fill: "#fff",
				}}
			/>
