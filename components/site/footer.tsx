	...
	return (
		<footer className={cn("bg-teal-50", className)}>
			<div className="relative mx-auto px-4 py-6 sm:px-6 lg:px-8 lg:pt-24">
				...
				<div className="lg:flex lg:items-end lg:justify-between">
					<div>
						...
						<p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 lg:text-left">
							Encontre sua equipe ideal ou crie seu próprio time, gerencie seus atletas e participe de ligas lendárias!
						</p>
					</div>
				...
				<div className="border-t border-gray-200 mt-3 pt-4 sm:flex sm:items-center sm:justify-between">
					<p className="text-center text-sm text-gray-500 sm:text-left">Copyright &copy; 2024. All rights reserved.</p>
